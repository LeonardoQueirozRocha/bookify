...
namespace Bookify.Infrastructure.Migrations
{
    ...
    [Migration("20260202230700_Add_User_IdentityId")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookify.Domain.Apartments.Entities.Apartment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bookify.Domain.Bookings.Entities.Booking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bookify.Domain.Reviews.Entities.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Bookify.Domain.Apartments.Entities.Apartment", b =>
                {
                    b.OwnsOne("Bookify.Domain.Shared.ValuesObjects.Money", "CleaningFee", b1 =>
                        {
                    ...
                    b.OwnsOne("Bookify.Domain.Shared.ValuesObjects.Money", "Price", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookify.Domain.Apartments.ValuesObjects.Address", "Address", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Bookify.Domain.Bookings.Entities.Booking", b =>
                {
                    b.HasOne("Bookify.Domain.Apartments.Entities.Apartment", null)
                        .WithMany()
                        .HasForeignKey("ApartmentId")
                    ...
                    b.OwnsOne("Bookify.Domain.Shared.ValuesObjects.Money", "AmenitiesUpCharge", b1 =>
                        {
                    ...
                    b.OwnsOne("Bookify.Domain.Shared.ValuesObjects.Money", "PriceForPeriod", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookify.Domain.Shared.ValuesObjects.Money", "TotalPrice", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookify.Domain.Bookings.ValuesObjects.DateRange", "Duration", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Bookify.Domain.Reviews.Entities.Review", b =>
                {
                    ...
                    b.HasOne("Bookify.Domain.Bookings.Entities.Booking", null)
                        .WithMany()
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
